...
For detailed overview of SDP, refer to the document linked [SDP(Spark 4.1)](https://github.com/Ahb98/rocket-ship/blob/main/Spark%20Declarative%20Pipeline.md)
